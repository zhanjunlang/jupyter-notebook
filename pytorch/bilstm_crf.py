...
索引 :math:`i` 处字的释放势能来自于 :math:`i` 时间处的 Bi-LSTM 的隐藏状态. 
...
class BiLSTM_CRF(nn.Module):
    ...
    def neg_log_likelihood_with_viterbi(self, sentence, tags):
        feats = self._get_lstm_features(sentence)
...
for epoch in range(
    ...
    for sentence, tags in training_data:
        ...
        # 第三步: 运行前向传递. 
        neg_log_likelihood = model.neg_log_likelihood_with_viterbi(sentence_in, targets)
